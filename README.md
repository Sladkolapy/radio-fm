...
- [Как запустить](#как-запустить)
  - [Локально для разработки](#вариант-1-локально-для-разработки)
  - [Docker Compose для разработки](#вариант-2-через-docker-compose-для-разработки)
  - [Production одним Express-сервером](#вариант-3-production-одним-express-сервером)
  - [Production через Docker Compose](#вариант-4-production-через-docker-compose)
...
- [Важные файлы данных](#важные-файлы-данных)
...
- `docs/PROJECT.md` — входная страница и карта документации.
- `docs/ARCHITECTURE.md` — архитектура и структура репозитория.
- `docs/BACKEND.md` — backend, БД, auth, загрузка файлов и API-карта.
- `docs/FRONTEND.md` — frontend, маршруты, состояние, API-клиент и offline-аудио.
- `docs/DEPLOYMENT.md` — запуск, Docker, production, env и backup.
- `docs/TESTING.md` — тесты и проверки.
- `docs/MAINTENANCE.md` — где что менять и текущие нюансы.
